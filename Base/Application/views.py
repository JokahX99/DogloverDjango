...
def alimentos(request):
    return render(request, 'Application/alimentos.html')

def accesorios(request):
    return render(request, 'Application/accesorios.html')
...
def tienda(request):
    ...
    productos = ProductoP.objects.all()
    return render(request,"tienda.html", {'productos':productos})

def agregar_productoP(request, producto_id):
    carrito = Carrito(request)
    producto = ProductoP.objects.get(id=producto_id)
